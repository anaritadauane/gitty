  ...
  return (
    <div role='tablist' className='tabs tabs-bordered'>
        ...
        <div className='font-RobotoMono drawer lg:drawer-open' id='sidebar'>
          ...
          <div className='drawer-content px-10 py-4'>
            ...
            <div className='flex justify-between'>
              <h1 className='font-bold sm:text-2xl text-lg self-centeront-bold text-lg self-center'>
                Issues
              </h1>
              <label
                htmlFor='my-drawer-2'
      ...
      <input
        ...
        name='my_tabs_1'
        role='tab'
        className='tab bg-base-200 rounded-r-lg drawer-open:hidden'
        aria-label='Projects'
      />
      <div role='tabpanel' className='tab-content'>
        <div className='font-RobotoMono drawer lg:drawer-open' id='sidebar'>
          ...
          <div className='drawer-content px-10 py-4'>
            {/* Page content here */}
            <div className='flex justify-between'>
              <h1 className='font-bold sm:text-2xl text-lg self-center'>
                Git Repositories
              </h1>
              <label
                htmlFor='my-drawer-3'
